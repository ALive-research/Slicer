...
public:
  ...
  const char* GetPlacementIcon() override {return ":/Icons/MarkupsPlaneMouseModePlace.png";}
  ...
  /// Get markup name
  const char* GetMarkupName() override {return "Plane";};

  /// Get markup short name
  const char* GetMarkupShortName() override {return "P";};
