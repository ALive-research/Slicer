...
public:
  ...
  const char* GetIcon() override {return ":/Icons/MarkupsROIMouseModePlace.png";}
  const char* GetAddIcon() override {return ":/Icons/MarkupsROIMouseModePlaceAdd.png";}
  ...
  /// Get markup name
  const char* GetMarkupName() override {return "ROI";};

  /// Get markup short name
  const char* GetMarkupShortName() override {return "R";};
