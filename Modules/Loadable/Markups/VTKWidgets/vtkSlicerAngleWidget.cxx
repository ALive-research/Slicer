...
{
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkSlicerAngleWidget");
  if(ret)
    {
    return static_cast<vtkSlicerAngleWidget*>(ret);
    }

  vtkSlicerAngleWidget* result = new vtkSlicerAngleWidget;
