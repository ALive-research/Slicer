...
{
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkSlicerClosedCurveWidget");
  if(ret)
    {
    return static_cast<vtkSlicerClosedCurveWidget*>(ret);
    }

  vtkSlicerClosedCurveWidget* result = new vtkSlicerClosedCurveWidget;
