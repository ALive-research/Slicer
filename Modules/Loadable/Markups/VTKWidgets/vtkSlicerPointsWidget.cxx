...
{
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkSlicerPointsWidget");
  if(ret)
    {
    return static_cast<vtkSlicerPointsWidget*>(ret);
    }

  vtkSlicerPointsWidget* result = new vtkSlicerPointsWidget;
