...
// --------------------------------------------------------------------------
qSlicerMarkupsCurveSettingsWidget::qSlicerMarkupsCurveSettingsWidget(QWidget *parent)
: Superclass(parent), d_ptr(new qSlicerMarkupsCurveSettingsWidgetPrivate(*this))
{
  this->setup();
}
...
// --------------------------------------------------------------------------
void qSlicerMarkupsCurveSettingsWidget::setMRMLMarkupsNode(vtkMRMLMarkupsNode* markupsNode)
{
